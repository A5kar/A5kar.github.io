...
The proof uses the identity $$f_X(x)f_Y(z-x)=f_Z(z)f_{X\lvert Z}(x\lvert z)$$, where $$X\lvert Z\sim\mathcal N(\mu_{X\lvert Z},\sigma_{X\lvert Z}^2)$$, achieved by [reshuffling](/2022/01/24/further-topics-on-RV.html#proof_sum_normal) some terms, where $$\mu_{X\lvert Z}=\frac{(z-\mu_Y)\sigma_X^2+\mu_X\sigma_Y^2}{\sigma_X^2+\sigma_Y^2}$$ and $$\sigma_{X\lvert Z}^2=\frac{\sigma_X^2\sigma_Y^2}{\sigma_X^2+\sigma_Y^2}$$,leading to the desired outcome.
...
To prove that $$f_X(x)f_Y(z-x)=f_Z(z)f_{X\lvert Z}(x\lvert z)$$, where $$\mu_Z=\mu_X+\mu_Y$$, $$\sigma_Z^2=\sigma_X^2+\sigma_Y^2$$, $$\mu_{X\lvert Z}=\frac{(z-\mu_Y)\sigma_X^2+\mu_X\sigma_Y^2}{\sigma_X^2+\sigma_Y^2}$$ and $$\sigma_{X\lvert Z}^2=\frac{\sigma_X^2\sigma_Y^2}{\sigma_X^2+\sigma_Y^2}$$, consider the following derivation.
...
A&=\frac{(x-\mu_X)^2}{\sigma_X^2}+\frac{(z-x-\mu_Y)^2}{\sigma_Y^2}\\
&=\frac{x^2\sigma_Z^2-2x((z-\mu_Y)\sigma_X^2+\mu_X\sigma_Y^2)+(z-\mu_Y)^2\sigma_X^2+\mu_X^2\sigma_Y^2}{\sigma_X^2\sigma_Y^2}\\
&=\frac{x^2-2x\mu_{X\lvert Z}+{\color{red}\mu_{X\lvert Z}^2-\mu_{X\lvert Z}^2}+((z-\mu_Y)^2\sigma_X^2+\mu_X^2\sigma_Y^2)(\sigma_X^2+\sigma_Y^2)^{-1}}{\sigma_{X\lvert Z}^2}\\
&=\frac{(x-\mu_{X\lvert Z})^2}{\sigma_{X\lvert Z}^2}+\frac{-\mu_{X\lvert Z}^2+((z-\mu_Y)^2\sigma_X^2+\mu_X^2\sigma_Y^2)(\sigma_X^2+\sigma_Y^2)^{-1}}{\sigma_{X\lvert Z}^2}\\
&=\frac{(x-\mu_{X\lvert Z})^2}{\sigma_{X\lvert Z}^2}+\frac{(z-\mu_Z)^2}{\sigma_Z^2}\text{, accordingly}
\end{align}$$
$$\begin{align}
