...
Accordingly, where **probability** studies randomness (a way of modeling lack of information) of a phenomenon{% if jekyll.environment == "development" %} (see [L1 Q5](https://learning.edx.org/course/course-v1:MITx+18.6501x+2T2021/block-v1:MITx+18.6501x+2T2021+type@sequential+block@u1s1_whatisstats/block-v1:MITx+18.6501x+2T2021+type@vertical+block@u1s1_whatisstats-tab5), [L1 Q8](https://learning.edx.org/course/course-v1:MITx+18.6501x+2T2021/block-v1:MITx+18.6501x+2T2021+type@sequential+block@u1s1_whatisstats/block-v1:MITx+18.6501x+2T2021+type@vertical+block@u1s1_whatisstats-tab8) and [L1 Q9](https://learning.edx.org/course/course-v1:MITx+18.6501x+2T2021/block-v1:MITx+18.6501x+2T2021+type@sequential+block@u1s1_whatisstats/block-v1:MITx+18.6501x+2T2021+type@vertical+block@u1s1_whatisstats-tab9)){% endif %}, which may be completely known (e.g. tossing a coin), **statistics** focuses on processes where parameters are not known and need to be estimated from data{% if jekyll.environment == "development" %} (see [L1 Q6](https://learning.edx.org/course/course-v1:MITx+18.6501x+2T2021/block-v1:MITx+18.6501x+2T2021+type@sequential+block@u1s1_whatisstats/block-v1:MITx+18.6501x+2T2021+type@vertical+block@u1s1_whatisstats-tab6)){% endif %}.
...
In general, if $$\mathbb E[T_n]\xrightarrow[n\rightarrow\infty]{}T$$ and $$\text{var}(T_n)\xrightarrow[n\rightarrow\infty]{}0$$, then $$T_n\xrightarrow[n\rightarrow\infty]{\mathbb P}T$$. The converse, however, is not true and convergence in probability of $$T_n$$ **does not imply** that $$\mathbb E[T_n]$$ converges{% if jekyll.environment == "development" %} (see [L2 Q7](https://learning.edx.org/course/course-v1:MITx+18.6501x+2T2021/block-v1:MITx+18.6501x+2T2021+type@sequential+block@u1s2_probredux/block-v1:MITx+18.6501x+2T2021+type@vertical+block@u1s2_probredux-tab7)){% endif %}.
...
|Find $${\color{red} n}$$ s.t. $$\mathbb P(S_{\color{red}n}\le a)=b$$|$$\displaystyle\frac{a-{\color{red} n}\mu_X}{\sqrt{\color{red} n}\sigma}=q_b$$, where $$\Phi(q_b)=b$${% if jekyll.environment == "development" %}<br>(see [PS8 Q4](https://learning.edx.org/course/course-v1:MITx+6.431x+1T2020/block-v1:MITx+6.431x+1T2020+type@sequential+block@Problem_Set_8/block-v1:MITx+6.431x+1T2020+type@vertical+block@ch12-s7-tab4)){% endif %}|
