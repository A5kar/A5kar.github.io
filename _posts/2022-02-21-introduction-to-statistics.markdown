...
To understand how the Normal approximation can be affected by dependency assume $$M\sim\text{Ber}(\frac 1 2)$$ and $$X_i\overset{\text{i.i.d.}}{\sim}\mathcal N(M,1)$$. In this example, even though $$X_i$$ are i.i.d. the mode of all PDF will strongly depends on the **common** value of $$M$$, which has the same chances to be $$0$$ or $$1$$. Accordingly, the PDF of $$X$$ will not be a Normal, as it will have two modes, around $$0$$ and $$1$${% if jekyll.environment == "development" %} (see [Prob L19 Q5](https://learning.edx.org/course/course-v1:MITx+6.431x+1T2020/block-v1:MITx+6.431x+1T2020+type@sequential+block@Lec__19_The_Central_Limit_Theorem__CLT_/block-v1:MITx+6.431x+1T2020+type@vertical+block@ch12-s3-tab5) and [Prob PS8 Q6](https://learning.edx.org/course/course-v1:MITx+6.431x+1T2020/block-v1:MITx+6.431x+1T2020+type@sequential+block@Problem_Set_8/block-v1:MITx+6.431x+1T2020+type@vertical+block@ch12-s7-tab6)){% endif %}. This, would have been avoided if $$X_i\overset{\text{i.i.d.}}{\sim}\mathcal N(M_i,1)$$, where $$M_i\overset{\text{i.i.d.}}{\sim}\text{Ber}(\frac 1 2)$$.
