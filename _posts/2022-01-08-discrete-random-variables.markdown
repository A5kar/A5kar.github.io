...
|Variance|$$\text{var}(aX+bY)=a^2\text{var}(X)+b^2\text{var}(Y)$${% if jekyll.environment == "development" %} (see [L7 Q13](https://learning.edx.org/course/course-v1:MITx+6.431x+1T2020/block-v1:MITx+6.431x+1T2020+type@sequential+block@Lec__7_Conditioning_on_a_random_variable__Independence_of_r_v_s/block-v1:MITx+6.431x+1T2020+type@vertical+block@ch6-s4-tab13)){% endif %}|
